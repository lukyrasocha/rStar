...
#BSUB -J discriminate_1160_1217
#BSUB -n 4
#BSUB -R "span[hosts=1]"
#BSUB -R "rusage[mem=20GB]"
#BSUB -u s233498@student.dtu.dk
#BSUB -W 05:00
#BSUB -o hpc_outputs/discriminate_1160_1217%J.out
#BSUB -e hpc_outputs/discriminate_1160_1217%J.err
...
CUDA_VISIBLE_DEVICES=0 python run_src/do_discriminate.py \
    ...
    --root_dir run_outputs/GSM8K/Mistral-7B-v0.1/Generator/test_1160_1217 \
    --dataset_name GSM8K \
    --note default